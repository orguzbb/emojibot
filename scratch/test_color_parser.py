...
print("Gold:", parse_svg_color("gold"))
print("Red #ff0000:", parse_svg_color("#ff0000"))
print("rgba(100, 200, 50, 0.5):", parse_svg_color("rgba(100, 200, 50, 0.5)"))
print("none:", parse_svg_color("none"))
